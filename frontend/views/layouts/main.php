...
$menuItems = [
            ...
            if (Yii::$app->user->isGuest) {
            	...
            	$menuItems[] = ['label' => 'Convocatorias', 'url' => ['/site/convocatoria']];
            	$menuItems[] = ['label' => 'Mis Postulaciones', 'url' => ['/site/mipostulacion']];
            	$menuItems[] = ['label' => 'Datos personales', 'url' => ['/site/datospersonales']];
                $menuItems[] = [
