        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['index','contact','resultados','preguntasfrecuentes','bases','error','captcha'],
                        'allow' => true,
                    ],                    
                    [
                        'actions' => ['logout','datospersonales','mipostulacion','guardarpostulacion','convocatoria','postular','section1','section2','section3','section4','section5','section6','section7','section8','descargarborrador','descargarpostulacion','mostrardetallepostulacion'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
