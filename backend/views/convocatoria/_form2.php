...
<br>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php echo $form->field($model, 'id_fondo')->dropDownList( $var = \yii\helpers\ArrayHelper :: map(fondo :: find()->all(),'nombre_fondo','nombre_fondo') ,['class'=>'form-control','prompt'=>'Seleccionar']); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-3">
